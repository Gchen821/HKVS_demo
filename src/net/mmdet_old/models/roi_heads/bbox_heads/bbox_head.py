...
from src.net.mmdet.core import build_bbox_coder, multi_apply, multiclass_nms
from src.net.mmdet.models.builder import HEADS, build_loss
from src.net.mmdet.models.losses import accuracy
from src.net.mmdet.models.utils import build_linear_layer
...
class BBoxHead(BaseModule):
    ...
    def refine_bboxes(self, rois, labels, bbox_preds, pos_is_gts, img_metas):
        ...
        Example:
            ...
            >>> import kwarray
            >>> import numpy as np
            >>> from src.net.mmdet.core.bbox.demodata import random_boxes
    ...
    def onnx_export(self,
        ...
        from src.net.mmdet.core.export import add_dummy_nms_for_onnx
