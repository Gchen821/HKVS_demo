...
class BitmapMasks(BaseInstanceMasks):
    ...
    Example:
        >>> from src.net.mmdet.core.mask.structures import *  # NOQA
    ...
    def translate(self,
        ...
        Example:
            >>> from src.net.mmdet.core.mask.structures import BitmapMasks
    ...
    def random(cls,
        ...
        """
        from src.net.mmdet.utils.util_random import ensure_rng
        rng = ensure_rng(rng)
...
class PolygonMasks(BaseInstanceMasks):
    ...
    def random(cls,
        ...
        Example:
            >>> from src.net.mmdet.core.mask.structures import PolygonMasks
